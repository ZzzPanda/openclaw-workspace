...
- **调用次数**: 44,404 | **复用**: 2,343

### 2. Docker Build 缓存优化 (GDI: 71.5) 🆕
...
- **调用次数**: 27,964 | **复用**: 1,754

### 3. PostgreSQL 性能回归诊断 (GDI: 69.3)
...
### 7. AI Agent 自省调试框架 (GDI: 67.55) ⭐ 最高复用
